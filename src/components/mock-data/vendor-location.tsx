    ...
    'features': [
      {
        ...
        geometry: {
          type: 'Point',
          coordinates: [-157.8241926, 21.2758128]
        },
        properties: {
      ...
      },
      {
        ...
        geometry: {
          type: 'Point',
          coordinates: [-157.81966, 21.2906615]
        },
        properties: {
          ...
          phone: '808-213-6646',
          address: '2734 S King St',
          city: 'Honolulu',
          state: 'HI',
          postalCode: '96826',
          logoUrl: 'https://thepineappleexp.com/wp-content/uploads/2023/09/pineapple-logo-crop.png'
        }
      },
      {
        type: 'Feature',
        ...
        properties: {
          ...
          state: 'HI',
          postalCode: '96815',
          logoUrl: 'https://www8.honolulu.gov/des/wp-content/uploads/sites/23/elementor/thumbs/CC-Logo-4C-Horizontal-qiubh0xr93p1q1zr4dgibugm5j9gwltnhmpedmaf68.png'
        }
      },
      {
        type: 'Feature',
        ...
        properties: {
          ...
          phone: '808-259-1879',
          address: '101 Uluniu Ave',
          city: 'Honolulu',
          state: 'HI',
          postalCode: '96815',
          logoUrl: 'https://ixplor-app-s3-bucket-01.s3.us-east-2.amazonaws.com/oahusurfschool.JPG'
        }
      },
      {
        type: 'Feature',
        geometry: {
          type: 'Point',
          coordinates: [-157.82462, 21.27634]
        },
        properties: {
          ...
          phone: '808-923-0189',
          address: '2420 Koa Ave # 201',
          city: 'Honolulu',
          state: 'HI',
          postalCode: '96815',
          logoUrl: 'https://koaboardsports.com/img/KBS_logo.jpg'
        }
      }
    ]
      } as const;
