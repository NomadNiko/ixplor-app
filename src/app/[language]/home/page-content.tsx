        ...
        >
          ...
          <Box
            sx={{
              ...
              paddingBottom: { xs: `calc(${theme.spacing(2)} + env(safe-area-inset-bottom))`, md: theme.spacing(2) }, // Add extra padding on mobile for safe area
              backgroundColor: 'rgba(28, 40, 58, 0.8)',
              backdropFilter: 'blur(10px)',
